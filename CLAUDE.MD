...
- 100 char line limit (enforced by `.prettierrc` `printWidth: 120`, but target 100)
- Invert dependencies
...
- Follow the rules in [.prettierrc](./.prettierrc): `singleQuote`, `semi`, `tabWidth: 2`, `printWidth: 120`, `trailingComma: "none"`, `arrowParens: "always"`
