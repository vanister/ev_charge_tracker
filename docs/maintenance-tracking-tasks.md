...
- [x] 2. Add `MaintenanceFormData` and `MaintenanceRecord` types to `src/pages/vehicles/maintenance/maintenance-types.ts` [§1 — MaintenanceRecord Schema, §2 — Type Conventions]
