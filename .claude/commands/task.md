...
If no task list was specified, check `docs/` for available task list files (e.g. `tasks.md`, `sync-system-tasks.md`, `maintenance-tracking-tasks.md`, `*-tasks.md`), list them, and ask the user which one to use. Do not assume or default to any file — always ask.
